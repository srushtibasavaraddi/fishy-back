    ...
    return (
        <div className = "flex flex-col items-center justify-center h-full">
            ...
            {players.map((player, index) => 
                <li key = {index} className = {'inline-block mt-5 p-5 xs-mobile:p-2'}>
            ...
            <Button display = {'bg-btn-bg-primary text-warning btn-lg'} text = {'Start Game'} clickHandler = {clickHandler} />
            </Link>) : (null) }
