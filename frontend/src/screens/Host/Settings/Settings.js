...
const Settings = ({showSettings}) => {
    ...
    return (
        ...
        <div className = "inline-flex justify-end">
            ...
            <Heading text = {'Settings'} display = {'md:text-2xl xs-mobile:text-lg text-warning'} />
            </div>
            <div className = "inline-block">
            <button onClick = {() => showSettings(false)} className="text-light text-2xl hover:text-light">
                    &times;
            </button>
            </div>
        </div>
        <div className = "flex flex-row justify-center items-center p-5">
            <label htmlFor = "timer" className = "text-warning md:text-xl xs-mobile:text-lg p-5">Set Timer</label>
            <input
            type="text"
        ...
        <Button
        text = {'Save'}
        display = {'btn btn-warning btn-lg ml-auto mr-auto'}
