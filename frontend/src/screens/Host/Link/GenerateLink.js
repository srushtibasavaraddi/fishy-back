    ...
    <div className="flex flex-col h-screen">
      <div className="flex justify-end items-center">
        <div className="inline-block">
          <Button
            text={"Settings"}
            display={"bg-btn-bg-primary btn-lg mr-auto text-warning"}
            clickHandler={() => showSettings(!settings)}
          />
        </div>
      ...
      {code ? (
        <div className="m-auto">
          <Heading
            display={`text-center font-normal text-2xl mt-6 mb-5 inline-block`}
            text={`Room code: ${code}`}
          />
        </div>
      ) : (
      ...
      {code ? (
        ...
        >
          <Button
            display={
              "bg-btn-bg-primary text-warning btn-lg absolute bottom-5 right-5"
            }
            text={"Next"}
            clickHandler={ClickHandler}
          />
